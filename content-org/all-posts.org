...
* DONE About Me :@aboutme:
:PROPERTIES:
:EXPORT_FILE_NAME: About_Me
:EXPORT_HUGO_WEIGHT: 1
:END:

Hi! I'm colawithsauce, majored in Computer Science, pursuing my Master's degree now. You can find posts about Emacs, HPC, CPP, Philosophy, and other articles

- Github：https://github.com/colawithsauce
